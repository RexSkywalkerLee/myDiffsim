...
writer = SummaryWriter('fold_expert_out01/exp1')

handles = [25, 30] 

print(sys.argv)
if len(sys.argv)==1:
	out_path = 'fold_expert_out01'
else:
	out_path = sys.argv[1]
...
with open('conf/rigidcloth/fold_cloth/flag.json','r') as f:
	config = json.load(f)

goal = []
with open('meshes/rigidcloth/fold_cloth/folded_flag.obj','r') as f:
    for line in f:
        if 'v ' in line:
